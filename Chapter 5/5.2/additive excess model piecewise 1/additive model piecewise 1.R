...
vec.sim.excess.piecewise <- function(t.vec,chi.vec,x.matrix,beta.vec){
...
poisson.band.1.nr.1 <- rep(0,n.sim.models)
poisson.band.2.nr.1 <- rep(0,n.sim.models)
poisson.band.3.nr.1 <- rep(0,n.sim.models)
poisson.band.4.nr.1 <- rep(0,n.sim.models)
poisson.band.5.nr.1 <- rep(0,n.sim.models)
poisson.band.6.nr.1 <- rep(0,n.sim.models)
poisson.band.7.nr.1 <- rep(0,n.sim.models)
poisson.band.8.nr.1 <- rep(0,n.sim.models)

poisson.band.1.nr.2 <- rep(0,n.sim.models)
poisson.band.2.nr.2 <- rep(0,n.sim.models)
poisson.band.3.nr.2 <- rep(0,n.sim.models)
poisson.band.4.nr.2 <- rep(0,n.sim.models)
poisson.band.5.nr.2 <- rep(0,n.sim.models)
poisson.band.6.nr.2 <- rep(0,n.sim.models)

ml.band.1.nr.1 <- rep(0,n.sim.models)
ml.band.2.nr.1 <- rep(0,n.sim.models)
ml.band.3.nr.1 <- rep(0,n.sim.models)
ml.band.4.nr.1 <- rep(0,n.sim.models)
ml.band.5.nr.1 <- rep(0,n.sim.models)
ml.band.6.nr.1 <- rep(0,n.sim.models)
ml.band.7.nr.1 <- rep(0,n.sim.models)
ml.band.8.nr.1 <- rep(0,n.sim.models)

ml.band.1.nr.2 <- rep(0,n.sim.models)
ml.band.2.nr.2 <- rep(0,n.sim.models)
ml.band.3.nr.2 <- rep(0,n.sim.models)
ml.band.4.nr.2 <- rep(0,n.sim.models)
ml.band.5.nr.2 <- rep(0,n.sim.models)
ml.band.6.nr.2 <- rep(0,n.sim.models)
...
for(i in 1:n.sim.models){
  ...
  test.fit.poisson.1 <- rsadd(Surv(time.obs*365.241,delta.i)~age+as.factor(gender)+as.factor(treatment),data=final.data.set,
                              ratetable = nortab,int=c(0,1,2,3,4,5,10,15,21),method="glm.poi",rmap = list(age=age*365.241,sex=gender,year=mdy.date(1,1,year)))
  test.fit.poisson.2 <- rsadd(Surv(time.obs*365.241,delta.i)~age+as.factor(gender)+as.factor(treatment),data=final.data.set,
                              ratetable = nortab,int=c(0,2.5,5,7.5,10,15,21),method="glm.poi",rmap = list(age=age*365.241,sex=gender,year=mdy.date(1,1,year)))
  ...
  test.fit.ml.1 <- rsadd(Surv(time.obs*365.241,delta.i)~age+as.factor(gender)+as.factor(treatment),data=final.data.set,
                         ratetable = nortab,int=c(0,1,2,3,4,5,10,15,21),method="max.lik",rmap = list(age=age*365.241,sex=gender,year=mdy.date(1,1,year)))
  test.fit.ml.2 <- rsadd(Surv(time.obs*365.241,delta.i)~age+as.factor(gender)+as.factor(treatment),data=final.data.set,
                         ratetable = nortab,int=c(0,2.5,5,7.5,10,15,21),method="max.lik",rmap = list(age=age*365.241,sex=gender,year=mdy.date(1,1,year)))
  ...
  poisson.band.1.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[4])
  ml.band.1.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[4])
  poisson.band.2.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[5])
  ml.band.2.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[5])
  poisson.band.3.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[6])
  ml.band.3.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[6])
  poisson.band.4.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[7])
  ml.band.4.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[7])
  poisson.band.5.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[8])
  ml.band.5.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[8])
  poisson.band.6.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[9])
  ml.band.6.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[9])
  poisson.band.7.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[10])
  ml.band.7.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[10])
  poisson.band.8.nr.1[i] <- as.numeric(test.fit.poisson.1$coefficients[11])
  ml.band.8.nr.1[i] <- as.numeric(test.fit.ml.1$coefficients[11])
  
  poisson.band.1.nr.2[i] <- as.numeric(test.fit.poisson.2$coefficients[4])
  ml.band.1.nr.2[i] <- as.numeric(test.fit.ml.2$coefficients[4])
  poisson.band.2.nr.2[i] <- as.numeric(test.fit.poisson.2$coefficients[5])
  ml.band.2.nr.2[i] <- as.numeric(test.fit.ml.2$coefficients[5])
  poisson.band.3.nr.2[i] <- as.numeric(test.fit.poisson.2$coefficients[6])
  ml.band.3.nr.2[i] <- as.numeric(test.fit.ml.2$coefficients[6])
  poisson.band.4.nr.2[i] <- as.numeric(test.fit.poisson.2$coefficients[7])
  ml.band.4.nr.2[i] <- as.numeric(test.fit.ml.2$coefficients[7])
  poisson.band.5.nr.2[i] <- as.numeric(test.fit.poisson.2$coefficients[8])
  ml.band.5.nr.2[i] <- as.numeric(test.fit.ml.2$coefficients[8])
  poisson.band.6.nr.2[i] <- as.numeric(test.fit.poisson.2$coefficients[9])
  ml.band.6.nr.2[i] <- as.numeric(test.fit.ml.2$coefficients[9])
...
c(mean(poisson.band.1.nr.1),mean(poisson.band.2.nr.1),mean(poisson.band.3.nr.1),mean(poisson.band.4.nr.1),
  mean(poisson.band.5.nr.1),mean(poisson.band.6.nr.1),mean(poisson.band.7.nr.1),mean(poisson.band.8.nr.1))
c(sd(poisson.band.1.nr.1),sd(poisson.band.2.nr.1),sd(poisson.band.3.nr.1),sd(poisson.band.4.nr.1),
  sd(poisson.band.5.nr.1),sd(poisson.band.6.nr.1),sd(poisson.band.7.nr.1),sd(poisson.band.8.nr.1))

c(mean(ml.band.1.nr.1),mean(ml.band.2.nr.1),mean(ml.band.3.nr.1),mean(ml.band.4.nr.1),
  mean(ml.band.5.nr.1),mean(ml.band.6.nr.1),mean(ml.band.7.nr.1),mean(ml.band.8.nr.1))
c(sd(ml.band.1.nr.1),sd(ml.band.2.nr.1),sd(ml.band.3.nr.1),sd(ml.band.4.nr.1),
  sd(ml.band.5.nr.1),sd(ml.band.6.nr.1),sd(ml.band.7.nr.1),sd(ml.band.8.nr.1))

# True baseline hazard
true.baseline.hazard <- function(t){
  return(exp(-7*(0<=t & t<=1)-6.75*(1<t & t<=2)-6.5*(2<t & t<=3)-6.25*(3<t & t<=4)-6*(4<t & t<=5)-5.75*(5<t & t<=10)-5.5*(10<t & t<=15)-5.75*(15<t & t<=21)))
}
...
vec.cum.baseline.excess.hazard.func <- Vectorize(cum.baseline.excess.hazard.func)
...
lines(t.grid,vec.cum.baseline.excess.hazard.func(t.grid),col="red",lwd=3)

plot(lowess(lambda0.em.bwin.0[[1]][,1],lambda0.em.bwin.0[[1]][,2],f=0.15),type="l", ylim=c(0,0.0075),
...
lines(t.grid,true.baseline.hazard(t.grid),col="red",lwd=3)
...
plot(lowess(lambda0.em.bwin.1[[1]][,1],lambda0.em.bwin.1[[1]][,2],f=0.15),type="l", ylim=c(0,0.0075),
